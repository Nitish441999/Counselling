...
const Contact = () => {
  return (
    <section className="text-gray-600 body-font bg-gray-100 py-5">
      <div className="container flex flex-col md:flex-row lg:max-w-7xl w-full px-10 bg-white py-5 md:py-24 mx-auto section shadow-md rounded-xl p-5" id="contact-form">
        <div className="md:w-1/3 w-full">
          ...
          <p className="leading-relaxed text-xl text-gray-900">
            ...
            <a href="https://veilmail.io/e/FkKh7o" className="font-medium text-blue-600 hover:underline">click here to reveal our protected email address</a>
          </p>
          ...
          <span className="inline-flex mt-6 justify-center sm:justify-start">
            <a className="text-gray-500 hover:text-gray-900" target="_blank" href="https://twitter.com/example" rel="noopener noreferrer">
              <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-6 h-6" viewBox="0 0 24 24">
                <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
              </svg>
            </a>
            <a className="ml-3 text-gray-500 hover:text-gray-900" href="https://www.instagram.com/example/" target="_blank" rel="noopener noreferrer">
        ...
        <div className="md:w-2/3 w-full mt-10 md:mt-0 md:pl-28">
          ...
          <form action="https://fabform.io/f/{form-id}" method="post">
            ...
            <div className="p-2 w-full">
              <button type="submit" className="flex text-white bg-gray-900 border-0 py-4 px-6 focus:outline-none hover:bg-blue-900 rounded text-xl font-bold shadow-lg mx-0 flex-col text-center">
                Send Message ✉
              </button>
            </div>
            <p className="leading-relaxed text-xl text-gray-900 mt-8">
