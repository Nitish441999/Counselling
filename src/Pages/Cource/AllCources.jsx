...
import data from "../Collages/CollageData"; // Assuming the data file is correctly imported
...
function AllCollage() {
  ...
  console.log("courses Key:", `${path}collages`);

  // Get the specific list of courses from the filtered data
  const courses = filteredData?.[`${path}Courses`] || [];
